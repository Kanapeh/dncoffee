        ...
        <div className="container-custom relative z-10">
          <div className="max-w-md mx-auto">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-white mb-2 text-center" style={{ fontFamily: 'var(--font-playfair), serif' }}>
              Welcome <span className="text-[#D4AF37]" style={{ fontFamily: 'var(--font-cormorant), serif', fontWeight: 400 }}>Back</span>
            </h1>
            ...
            <form onSubmit={handleSubmit} className="bg-white/10 backdrop-blur-sm rounded-2xl border border-white/10 p-6 md:p-8 space-y-6">
              ...
              <div className="flex items-center justify-between">
                <label className="flex items-center gap-2">
                  <input type="checkbox" className="w-4 h-4 rounded border-white/20 bg-white/5 text-[#D4AF37] focus:ring-[#D4AF37]" />
                  <span className="text-sm text-white/70">Remember me</span>
                </label>
                <Link href="#" className="text-sm text-[#D4AF37] hover:text-[#8B6F47] transition-colors">
                  Forgot password?
                </Link>
              </div>
              ...
              <div className="text-center text-sm text-white/70">
                ...
                <Link href="/signup" className="text-[#D4AF37] hover:text-[#8B6F47] font-medium transition-colors">
                  Sign Up
                </Link>
              </div>
            </form>
